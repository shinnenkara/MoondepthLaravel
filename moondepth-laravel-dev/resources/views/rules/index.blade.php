...
<div class="container">
    ...
    <ol class="justify-text flow-text">
        <li>
            <p class="justify-text flow-text">You will not upload, post, discuss, request, or link to anything that violates local or Ukrainian law.</span>
        </li>
        <li>
            <p class="justify-text flow-text">You will immediately cease and not continue to access the site if you are under the age of 18.</span>
        </li>
        <li>
